    ...
    public class StudentController : ControllerBase
    {
        ...
        public JsonResult Get()
        {
            string query = @"
                    ...
                    ,PhotoFileName
                    from dbo.Student, dbo.Class where Student.Status = 1 and Student.ClassId = Class.ClassId
                    ";
        ...
        public JsonResult Post(Student stu)
        {
            string query = @"
                    ...
                    (StudentName,ClassId,DateOfBirth,PhotoFileName,Status)
                    values 
                    (
                    '" + stu.StudentName + @"'
                    ,'" + stu.ClassId + @"'
        ...
        {
            string query = @"
                    select ClassName from dbo.Class
                    ";
            DataTable table = new DataTable();
            string sqlDataSource = _configuration.GetConnectionString("EmployeeAppCon");
            SqlDataReader myReader;
